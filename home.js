...
console.log(greetUser("JerrySeinfeld1234"));
...
const canWeDeliver = zipCode => {
    if(deliveryAreaZipCodes.includes(zipCode)) {
        console.log('Congratulations! You are eligible for delivery!');
    } else {
        console.log('Our apologies. We can not deliver to your location.');
    }
};
